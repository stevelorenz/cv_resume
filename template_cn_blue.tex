...
%%           2024 Zuo Xiang (zuoxiang1991@icloud.com)
%
...
\familyname{相佐}
\firstname{}
\address{1991/08}{}  % optional, remove the line if not wanted
...
导师是Prof. Dr.-Ing. Dr. h.c. Frank H. P.
Fitzek。在博士学习期间，我的研究重点是通过网络功能虚拟化(NFV) 和
...
\cventry{2022.09-}{Cisco 思科系统}{软件工程师}{IOS-XE}{Integrated Services Routers (ISR)}
...
\section{学术出版物}
\cvline{IEEE~期刊}{张三，李四，王麻子 基于 latex 的简历凑字数研究[C]// CVChina. 2017.}
